...
/**
 * Created by Satyam on 7/27/2016.
 */
    public class FetchDemoDataTask extends AsyncTask<String,Integer,String> {

        private static Context ctx;
        public FetchDemoDataTask(Context ctx)
        {
            FetchDemoDataTask.ctx =ctx;
        }
        public FetchDemoDataTask()
        {

        }
        private Hashtable soundFlag = new Hashtable();
        //private Hashtable tempSoundFlag = new Hashtable();
        private final String LOG_TAG = FetchDemoDataTask.class.getSimpleName();
        //int resID = ctx.getResources().getIdentifier("isntit", "raw", ctx.getPackageName());
        ...
        protected String doInBackground(String...result) {
            ...
            try {
                final String FORECAST_BASE_URL = "http://198.57.174.253/plesk-site-preview/bestprotrade.com/198.57.174.253/nt8_ma/FetchDemoData.php?";
            ...
            //Log.v(LOG_TAG,"Demo Data from VPS is: " + instrumentJsonStr);
